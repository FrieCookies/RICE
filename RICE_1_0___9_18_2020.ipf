...
print "space n",gauss_out[tot][26]
...
print "Space k", gauss_out[tot][28]
...
prompt Scat_SD, "Standard Deviation Wave of Scattering Measurements (1/Mm)", popup, WaveList("*",";","")
prompt Abs_SD,  "Standard Deviation Wave of Absorption Measurements (1/Mm)", popup, WaveList("*",";","")
Prompt calc_type, "RI Calcuation type, 0=difference based (Frie et al. 2019), 1=\"chi squared based\" (Dingle et al. 2019)"
doprompt "Establish RI interation range", k_start,k_end,k_step,n_start,n_end,n_step


doprompt "Calculation Details" scat_sd,abs_sd,calc_type
...
wave RI_range=n_range
	...
	prompt nScat, "Observed Scattering Time Series (1/Mm)",popup, WaveList("*",";","")
	prompt nabs_Avg "Observed Absorption Time Series (1/Mm)" ,popup, WaveList("*",";","")
	Prompt DL_scat, "Scattering Detection Limit (1/Mm)"
	Prompt DL_Abs, "Absorption Detection Limit (1/Mm)"
	Prompt Thres, "Maximum Acceptable Relative Difference (decimal value)" 
	prompt Size_Mean, "Midpoint Diameters of Size Bins (nm)",popup, WaveList("*",";","")
	prompt Count, "dN/dlog(dp) (1/cm3), rows as dp, columns as time",popup, WaveList("*",";","")
	prompt Wavelength, "Wavelength of Optical Measurements(nm)"   
